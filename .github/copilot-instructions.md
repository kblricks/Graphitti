...
- C++17 with g++ 13.3.0.
- CMake 3.28.3.
- clang-format 18.1.3 (for style checks).
...
- Unit and regression tests: [.github/workflows/tests.yml](.github/workflows/tests.yml)
  - Runs `cmake ..`, `make -j`, `./tests`, then CPU regression sims and `compare_matrices`.
- Format check: [.github/workflows/format.yml](.github/workflows/format.yml)
